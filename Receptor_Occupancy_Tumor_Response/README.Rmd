...
A simulated dataset has been provided for this example: [Receptor_Occupancy_Tumor_Response.csv](Receptor_Occupancy_Tumor_Response.csv).  Part of this exercise involves you choosing what data to display and how, in order to support the Purpose. You may or may not use all of the information supplied in the dataset.
