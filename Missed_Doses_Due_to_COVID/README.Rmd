...
A simulated dataset has been provided for this example: [Missed_Doses_Due_to_COVID.csv](Missed_Doses_Due_to_COVID.csv). Part of this exercise involves you choosing what data to display and how, in order to support the Purpose. You may or may not use all of the information supplied in the dataset.
